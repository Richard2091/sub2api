export default {
    ...
    groups: {
      ...
      subscription: {
        resetMode: '\u91cd\u7f6e\u65b9\u5f0f',
        resetModeRolling: '\u6eda\u52a8\u7a97\u53e3',
        resetModeFixed: '\u56fa\u5b9a\u65f6\u95f4',
        resetHour: '\u91cd\u7f6e\u5c0f\u65f6',
        resetDay: '\u91cd\u7f6e\u661f\u671f',
        resetDate: '\u91cd\u7f6e\u65e5\u671f',
        timezone: '\u65f6\u533a',
        rollingDailyHint: '\u6bcf\u4e2a\u8ba2\u9605\u4ece\u5f00\u59cb\u65f6\u95f4\u8d77\u6309 24 \u5c0f\u65f6\u4e00\u4e2a\u7a97\u53e3\u3002',
        rollingWeeklyHint: '\u6bcf\u4e2a\u8ba2\u9605\u4ece\u5f00\u59cb\u65f6\u95f4\u8d77\u6309 7 \u5929\u4e00\u4e2a\u7a97\u53e3\u3002',
        rollingMonthlyHint: '\u6bcf\u4e2a\u8ba2\u9605\u4ece\u5f00\u59cb\u65f6\u95f4\u8d77\u6309 30 \u5929\u4e00\u4e2a\u7a97\u53e3\u3002',
        fixedDailyHint: '\u6bcf\u5929 {hour}:00\uff08{timezone}\uff09\u91cd\u7f6e\u3002',
        fixedWeeklyHint: '\u6bcf{day} {hour}:00\uff08{timezone}\uff09\u91cd\u7f6e\u3002',
        fixedMonthlyHint: '\u6bcf\u6708 {day} \u65e5 {hour}:00\uff08{timezone}\uff09\u91cd\u7f6e\u3002',
        title: '订阅设置',
        type: '计费类型',
