export default {
    ...
    groups: {
      ...
      subscription: {
        ...
        resetModeFixed: 'Fixed time',
        resetHour: 'Reset Hour',
        resetDay: 'Reset Day',
        resetDate: 'Reset Date',
        timezone: 'Timezone',
        rollingDailyHint: 'Each subscription uses 24-hour windows from its start time.',
        rollingWeeklyHint: 'Each subscription uses 7-day windows from its start time.',
        rollingMonthlyHint: 'Each subscription uses 30-day windows from its start time.',
        fixedDailyHint: 'Resets daily at {hour}:00 ({timezone}).',
        fixedWeeklyHint: 'Resets every {day} at {hour}:00 ({timezone}).',
        fixedMonthlyHint: 'Resets monthly on day {day} at {hour}:00 ({timezone}).',
