...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "quota_daily_reset_mode", Type: field.TypeString, Nullable: true, Size: 10},
		{Name: "quota_daily_reset_hour", Type: field.TypeInt, Nullable: true},
		{Name: "quota_weekly_reset_mode", Type: field.TypeString, Nullable: true, Size: 10},
		{Name: "quota_weekly_reset_day", Type: field.TypeInt, Nullable: true},
		{Name: "quota_weekly_reset_hour", Type: field.TypeInt, Nullable: true},
		{Name: "quota_monthly_reset_mode", Type: field.TypeString, Nullable: true, Size: 10},
		{Name: "quota_monthly_reset_day", Type: field.TypeInt, Nullable: true},
		{Name: "quota_monthly_reset_hour", Type: field.TypeInt, Nullable: true},
		{Name: "quota_reset_timezone", Type: field.TypeString, Nullable: true, Size: 64},
