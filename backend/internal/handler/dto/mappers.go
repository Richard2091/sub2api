...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		QuotaDailyResetMode:             g.GetQuotaDailyResetMode(),
		QuotaDailyResetHour:             g.GetQuotaDailyResetHour(),
		QuotaWeeklyResetMode:            g.GetQuotaWeeklyResetMode(),
		QuotaWeeklyResetDay:             g.GetQuotaWeeklyResetDay(),
		QuotaWeeklyResetHour:            g.GetQuotaWeeklyResetHour(),
		QuotaMonthlyResetMode:           g.GetQuotaMonthlyResetMode(),
		QuotaMonthlyResetDay:            g.GetQuotaMonthlyResetDay(),
		QuotaMonthlyResetHour:           g.GetQuotaMonthlyResetHour(),
		QuotaResetTimezone:              g.GetQuotaResetTimezone(),
